...
fn create_device_with_graphics_queues(
    ...
    Vec<hal::queue::CommandQueue<back::Backend, Graphics>>,
) {
    let family = adapter
        .queue_families
        .iter()
...
impl ApplicationState {
    pub fn new(window: Window, events_loop: EventsLoop) -> ApplicationState {
        init_hal(&window);
